...
class BlogList(ListView):
    ...
    # queryset = Blog.objects.order_by('-publish_date')    #for listing the blog list view in descending order w.r.t publish_time. But here I made this functionality in  models.
